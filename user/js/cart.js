...
(function () {
      ...
      <li class="item" data-id="${it.id}">
        ...
        <div>
          ...
          <div class="qty" aria-label="Quantity for ${it.title}">
            ...
            <input class="qty-val" type="number" min="1" max="99" value="${
              it.qty
            }">
  ...
  function recalc() {
    ...
    if (items.length) {
      if (code === "FREESHIP") shipping = 0;
        ...
        shipping =
          shipMethod.value === "express" ? SHIP_EXPRESS : SHIP_STANDARD;
    }
  ...
  const RECS = [
    ...
    },
    {
      ...
      price: 16.99,
      img: "https://images.unsplash.com/photo-1519681394605-5f7f14f4a2d3?q=80&w=1200&auto=format&fit=crop",
    },
    {
      ...
      <article class="rec">
        ...
        <div class="body">
          ...
          <div class="meta">
            ...
            <button class="btn add-rec" data-id="${r.id}" data-title="${
        r.title
      }" data-price="${r.price}" data-img="${r.img}">Add to Cart</button>
          </div>
        </div>
      </article>
    `
  ...
  checkoutBtn.addEventListener("click", () => {
    alert("The order has been places successfully!");
  });
})();
